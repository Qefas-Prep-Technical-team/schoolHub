...
import { getChildren, getChildDetails, getChildAssignments, getChildAssignmentDetails, getParentDashboard, updateProfile, updateChildProfile, getChildResults } from "./parent.controller";
...
router.get("/children/:childId/results", checkSubscription, getChildResults);

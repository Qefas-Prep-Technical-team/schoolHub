...
import { ArrowLeft, MessageSquare, Clock, Sparkles } from 'lucide-react-native';
        ...
        <View className="flex-1 bg-slate-50 dark:bg-slate-950">
            ...
            <SafeAreaView className="flex-1 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800" edges={['top']}>
                ...
                <View className="px-6 py-4 flex-row items-center border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 z-10">
                    ...
                    <View className="h-10 w-10 bg-sky-100 dark:bg-sky-900/50 rounded-full items-center justify-center mr-4 border border-sky-200 dark:border-sky-800">
                        <MessageSquare size={20} color="#0284c7" />
                    </View>
                    <View>
                        <Text className="text-xl font-bold text-slate-900 dark:text-white">Messages</Text>
                ...
                <View className="flex-1 bg-slate-50 dark:bg-slate-950 px-6 justify-center items-center">
                    <View className="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 p-8 items-center shadow-lg shadow-sky-500/5 max-w-sm w-full">
                        <View className="w-24 h-24 bg-sky-100 dark:bg-sky-900/30 rounded-[2rem] items-center justify-center mb-6">
                        ...
                        <Text className="text-center text-slate-500 dark:text-slate-400 font-Lexend leading-relaxed mb-8">
                            Direct messaging with your child's teachers and school administrators is currently under development. Stay tuned!
                        </Text>

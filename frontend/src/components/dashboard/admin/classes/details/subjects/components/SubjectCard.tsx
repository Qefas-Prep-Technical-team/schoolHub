...
const SubjectCard: React.FC<SubjectCardProps> = ({ subject, onClick }) => {
  return (
    <div 
      className="flex flex-col gap-4 rounded-xl bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-white/10 p-5 shadow-sm transition-all hover:shadow-lg hover:-translate-y-1 cursor-pointer"

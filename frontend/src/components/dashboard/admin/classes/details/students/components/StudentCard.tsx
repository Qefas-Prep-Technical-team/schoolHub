    ...
    >
      ...
      <div className="w-full flex justify-between text-sm text-gray-600 dark:text-gray-300 mb-4">
        <div className="text-center">
          <div className="font-bold text-gray-800 dark:text-white">{student.attendance || 0}%</div>
          <div className="text-xs text-gray-500 dark:text-gray-400">Attendance</div>
        </div>
        <div className="text-center">
          <div className="font-bold text-gray-800 dark:text-white">{student.lastScore || 0}%</div>

            ...
            <div className="container mx-auto px-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    <div>
                        ...
                        <p className="text-slate-400">The modern solution for school management.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a className="text-slate-400 hover:text-white transition-colors" href="#">Contact Support</a></li>
                        </ul>
                    </div>
                    <div>

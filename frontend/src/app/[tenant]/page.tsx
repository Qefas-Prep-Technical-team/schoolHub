          ...
          <nav className={`hidden md:flex items-center gap-8 text-sm font-medium ${
            ...
            {customPages.length > 0 ? (
              customPages.map((page: any) => (
                <Link key={page.id} href={page.slug === "/" ? `/${tenant}` : `/${tenant}${page.slug}`} className={`transition-colors duration-200 ${darkMode ? "hover:text-white" : "hover:text-slate-900"}`}>
                  {page.title}
                </Link>
              ))
            ) : (
          ...
          <div className={`md:hidden absolute top-20 left-0 w-full py-6 px-6 flex flex-col gap-5 shadow-2xl border-b transition-all duration-300 ${
            ...
            {customPages.length > 0 ? (
              customPages.map((page: any) => (
                <Link
                  key={page.id}
                  href={page.slug === "/" ? `/${tenant}` : `/${tenant}${page.slug}`}
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className={`text-xs mt-1 transition-colors duration-300 ${
                    darkMode ? "text-slate-400" : "text-slate-500"
                  }`}>{schoolData?.landingPage?.contactInfo?.address || "Greenwood Campus, Main Boulevard"}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className={`text-xs mt-1 transition-colors duration-300 ${
                    darkMode ? "text-slate-400" : "text-slate-500"
                  }`}>{schoolData?.landingPage?.contactInfo?.phone || "+234 801 234 5678"}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className={`text-xs mt-1 transition-colors duration-300 ${
                    darkMode ? "text-slate-400" : "text-slate-500"
                  }`}>{schoolData?.landingPage?.contactInfo?.email || `admissions@${tenant}.edu`}</p>
                </div>
              </div>
            </div>
          </div>

...
import { getRoleTheme, UserRole } from "@/lib/theme/roleTheme";
import {
  ShieldCheck,
  BookOpen,
  GraduationCap,
...
> = {
  ...
  SUPER_ADMIN: {
    ...
    subtitle: "Loading your system console...",
    steps: [
      "Verifying system credentials...",
      "Loading global data...",
      "Preparing system console...",
      "Almost there...",
    ],
  },
  TEACHER: {
...
> = ({ role, userName }) => {
  ...
  const meta = ROLE_META[role.toUpperCase()] ?? ROLE_META.ADMIN;
  const { Icon } = meta;
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950 overflow-hidden font-sans">
      {/* Ambient radial glow */}
      <div

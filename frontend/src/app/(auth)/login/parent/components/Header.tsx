            ...
            <div className="flex items-center justify-between whitespace-nowrap max-w-[1400px] mx-auto">
                <div className="flex items-center gap-3">
                    {branding.isBranded && branding.logo ? (
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white dark:bg-slate-900 shadow-xl border border-slate-200 dark:border-slate-800 p-1.5 transition-transform hover:rotate-3 duration-300">

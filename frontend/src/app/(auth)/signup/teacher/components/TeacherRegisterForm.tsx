      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6 p-4">
        ...
        <label className="flex flex-col">
          ...
          <input
            ...
            className={`form-input h-14 rounded-lg border bg-background-light dark:bg-background-dark p-4 text-base font-normal text-[#0d171b] dark:text-white placeholder:text-[#4c809a] focus:outline-none focus:ring-2 focus:ring-emerald-500/50 ${errors.fullName
        ...
        <label className="flex flex-col">
          ...
          <input
            ...
            className={`form-input h-14 rounded-lg border bg-background-light dark:bg-background-dark p-4 text-base font-normal text-[#0d171b] dark:text-white placeholder:text-[#4c809a] focus:outline-none focus:ring-2 focus:ring-emerald-500/50 ${errors.email
              ? 'border-red-500 dark:border-red-400'
              : 'border-input-border-light dark:border-input-border-dark'
              }`}
            disabled={isPending}
        ...
        <label className="flex flex-col">
          ...
          <div className="relative">
            <input
              ...
              className={`form-input h-14 w-full rounded-lg border bg-background-light dark:bg-background-dark p-4 pr-12 text-base font-normal text-[#0d171b] dark:text-white placeholder:text-[#4c809a] focus:outline-none focus:ring-2 focus:ring-emerald-500/50 ${errors.password
                ? 'border-red-500 dark:border-red-400'
                : 'border-input-border-light dark:border-input-border-dark'
                }`}
              disabled={isPending}
        ...
        <label className="flex flex-col">
          ...
          <div className="relative">
            <input
              ...
              className={`form-input h-14 w-full rounded-lg border bg-background-light dark:bg-background-dark p-4 pr-12 text-base font-normal text-[#0d171b] dark:text-white placeholder:text-[#4c809a] focus:outline-none focus:ring-2 focus:ring-emerald-500/50 ${errors.confirmPassword
                ? 'border-red-500 dark:border-red-400'
                : 'border-input-border-light dark:border-input-border-dark'
                }`}
              disabled={isPending}
          ...
          <div className={`transition-all duration-300 ease-in-out ${showOptional ? 'max-h-[1000px] opacity-100 p-4 space-y-6' : 'max-h-0 opacity-0 pointer-events-none'}`}>
            ...
            <label className="flex flex-col">
              ...
              <input
                ...
                className={`form-input h-14 rounded-lg border bg-background-light dark:bg-background-dark p-4 text-base font-normal text-[#0d171b] dark:text-white placeholder:text-[#4c809a] focus:outline-none focus:ring-2 focus:ring-emerald-500/50 ${errors.schoolCode
                  ? 'border-red-500 dark:border-red-400'
                  : 'border-input-border-light dark:border-input-border-dark'
                  }`}
            ...
            <label className="flex flex-col">
              ...
              <input
                ...
                className={`form-input h-14 rounded-lg border bg-background-light dark:bg-background-dark p-4 text-base font-normal text-[#0d171b] dark:text-white placeholder:text-[#4c809a] focus:outline-none focus:ring-2 focus:ring-emerald-500/50 ${errors.studentCode
                  ? 'border-red-500 dark:border-red-400'
                  : 'border-input-border-light dark:border-input-border-dark'
                  }`}
                disabled={isPending}
            ...
            <label className="flex flex-col">
              ...
              <input
                ...
                className={`form-input h-14 rounded-lg border bg-background-light dark:bg-background-dark p-4 text-base font-normal text-[#0d171b] dark:text-white placeholder:text-[#4c809a] focus:outline-none focus:ring-2 focus:ring-emerald-500/50 ${errors.classCode
                  ? 'border-red-500 dark:border-red-400'
                  : 'border-input-border-light dark:border-input-border-dark'
                  }`}
                disabled={isPending}
        ...
        <div className="flex items-center p-2 rounded-lg border border-transparent hover:border-emerald-600/20 hover:bg-emerald-600/5 transition-all duration-300">
          <div className="flex items-center h-5">
            <input
              ...
              bg-background-light dark:bg-background-dark text-emerald-600 focus:ring-emerald-500/50 transition-all cursor-pointer"
              disabled={isPending}
            />
          </div>
          <label
          ...
          <div className="flex items-start">
            <div className="flex items-center h-5">
              <input
                ...
                className={`h-5 w-5 rounded border bg-background-light dark:bg-background-dark text-emerald-600 focus:ring-emerald-500/50 transition-all cursor-pointer ${errors.acceptTerms ? 'border-red-500' : 'border-input-border-light dark:border-input-border-dark'}`}
                disabled={isPending}
              />
            </div>
            <label
        ...
        <button
          type="submit"
          disabled={isPending}
          className="group relative flex h-14 w-full cursor-pointer items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-700 dark:from-emerald-500 dark:via-green-500 dark:to-emerald-600 text-base font-bold text-white shadow-lg shadow-emerald-500/25 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/40 hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-emerald-500/30 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none overflow-hidden"
        >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden transform animate-in zoom-in duration-300">
            ...
            <div className="p-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-slate-800/50">
              <button
                onClick={() => setShowPrivacyModal(false)}
                className="w-full py-3 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-600/90 transition-all shadow-lg shadow-primary/20"
              >
                I Understand
              </button>
            </div>

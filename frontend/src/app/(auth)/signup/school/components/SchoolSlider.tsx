    ...
    <div className="relative w-full h-full min-h-[600px] overflow-hidden rounded-2xl shadow-2xl">
      ...
      <div className="absolute bottom-10 left-6 right-6 lg:left-10 lg:right-10 z-20 bg-white/10 dark:bg-black/20 backdrop-blur-xl border border-white/20 p-6 rounded-2xl shadow-2xl">
        <div className="flex items-center gap-4 mb-3">
          <div className="w-12 h-12 rounded-full bg-blue-600/20 backdrop-blur-sm flex items-center justify-center shrink-0 border border-white/10">
            <span className="material-symbols-outlined text-white text-2xl">school</span>
          </div>
          <div>
            <h3 className="text-white font-bold text-lg leading-tight">Qefas Hub Cloud</h3>
            <p className="text-white/80 text-sm font-medium">Empowering modern education</p>
          </div>
        </div>
        <p className="text-white/90 text-sm leading-relaxed font-light">
          &ldquo;Join thousands of modern schools revolutionizing their campus management, communication, and learning experience in one seamless platform.&rdquo;
        </p>
      </div>
    </div>
  );

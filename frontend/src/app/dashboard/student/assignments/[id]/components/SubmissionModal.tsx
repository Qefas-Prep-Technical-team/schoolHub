        ...
        <div className="inline-block transform overflow-hidden rounded-lg bg-white dark:bg-slate-900 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
            ...
            <div className="mb-4">
              ...
              <div className="border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-lg p-4 text-center">
                ...
                />
                 <label
                  htmlFor="file-upload"
                  className="cursor-pointer inline-flex items-center gap-2 rounded-lg bg-primary dark:bg-pink-600 px-4 py-2 text-sm font-medium text-white hover:bg-primary/90 dark:hover:bg-pink-700"
                >
                  <span className="material-symbols-outlined">upload</span>
                  Choose Files
                </label>
                <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
                  Allowed formats: .pdf, .doc, .docx, .png, .jpg • Max size: 10MB
                </p>
              </div>
          ...
          <div className="border-t border-slate-200 dark:border-slate-800 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button
              ...
              className="inline-flex w-full justify-center rounded-lg bg-primary dark:bg-pink-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary/95 dark:hover:bg-pink-700 disabled:opacity-50 sm:ml-3 sm:w-auto"
            >
              {isSubmitting ? (

        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
                <button
                    ...
                    className="flex items-center justify-center h-9 w-9 rounded-lg border border-[#E5E7EB] dark:border-[#374151] bg-white dark:bg-[#1A232E] dark:text-white hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center justify-center h-9 w-9 rounded-lg border text-sm font-medium transition-colors ${currentPage === page
                                ? 'border-primary bg-primary/20 text-primary font-bold dark:text-white'
                                : 'border-[#E5E7EB] dark:border-[#374151] bg-white dark:bg-[#1A232E] dark:text-slate-300 hover:bg-primary/10 dark:hover:bg-primary/20'
                                }`}
                        >
                            {page}
                        </button>

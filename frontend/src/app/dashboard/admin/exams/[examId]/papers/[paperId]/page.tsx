...
import SubjectPaperReport from "@/app/dashboard/teacher/exams&quizzes/papers/[id]/components/SubjectPaperReport";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4 truncate">
            <Button 
                variant="ghost" 
                size="icon" 
                onClick={() => router.push(`/dashboard/admin/exams/${examId}/papers`)}

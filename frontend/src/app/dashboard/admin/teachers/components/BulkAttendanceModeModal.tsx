...
interface BulkAttendanceModeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectList: () => void;
  onSelectSwipe: () => void;
...
export const BulkAttendanceModeModal: React.FC<BulkAttendanceModeModalProps> = ({
  isOpen,
  onClose,
  onSelectList,
  onSelectSwipe,
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl w-full max-w-md border border-slate-100 dark:border-slate-800 shadow-2xl flex flex-col animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6">
          <p className="text-slate-500 dark:text-slate-400 mb-6 text-sm font-medium">
            How would you like to take attendance for the teachers today?
          </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                  View all teachers at once. Best for reviewing and adding specific notes.
                </p>
              </div>
            </button>
          </div>

...
import { Bell, Info, AlertCircle, Activity, Mail, Megaphone } from 'lucide-react';
...
export function NotificationStatsCard({ stats }: NotificationStatsCardProps) {
  const categories = [
    ...
    { label: 'Announcements', count: stats.announcements, icon: Megaphone, color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/20' },
  ];
    ...
    <Card className="rounded-[2rem] border border-slate-200/50 dark:border-slate-800/50 shadow-sm bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl sticky top-8">
      <CardContent className="p-6">
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 rounded-full bg-orange-400/20 flex items-center justify-center mb-4 relative">

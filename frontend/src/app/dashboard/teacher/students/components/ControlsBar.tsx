...
const ControlsBar: React.FC<ControlsBarProps> = ({ 
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 items-center mb-6 p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
      ...
      <div className="flex items-center gap-4 w-full lg:w-auto overflow-x-auto pb-2 lg:pb-0 px-2">
        ...
        <div className="h-6 w-px bg-slate-200 dark:bg-slate-800 hidden lg:block mx-1" />

export const TabSkeleton = ({ tabId }: { tabId: string }) => {
  if (tabId === "overview") {
    return (
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-pulse min-h-[calc(100vh-16rem)]">
        <div className="col-span-2 flex flex-col gap-6">
          <div className="bg-white dark:bg-emerald-950/60 p-6 rounded-2xl border border-slate-200/80 dark:border-emerald-800/50 space-y-4 shadow-sm shrink-0">
          ...
          <div className="bg-white dark:bg-emerald-950/60 p-6 rounded-2xl border border-slate-200/80 dark:border-emerald-800/50 space-y-4 shadow-sm flex-1">
        ...
        <div className="bg-white dark:bg-emerald-950/60 p-6 rounded-2xl border border-slate-200/80 dark:border-emerald-800/50 space-y-4 h-full shadow-sm overflow-hidden">
  ...
  return (
    <div className="bg-white dark:bg-emerald-950/60 rounded-2xl border border-slate-200/80 dark:border-emerald-800/50 p-6 space-y-4 shadow-sm animate-pulse min-h-[calc(100vh-16rem)]">

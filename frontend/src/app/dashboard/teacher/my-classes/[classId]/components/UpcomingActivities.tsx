        ...
        {activities.map((activity, idx) => (
          ...
          >
            ...
            <div className="flex items-center gap-5 relative z-10">
              <div className={`w-14 h-14 rounded-[1.25rem] flex items-center justify-center bg-slate-50 dark:bg-slate-900/50 shadow-inner transition-transform group-hover:scale-110 group-hover:rotate-3 border border-slate-200/50 dark:border-slate-800`}>
            ...
            <button className="relative z-10 p-3 rounded-xl bg-white/50 dark:bg-slate-900/50 text-slate-400 group-hover:text-amber-500 group-hover:shadow-md transition-all active:scale-95 border border-slate-200/50 dark:border-slate-800">

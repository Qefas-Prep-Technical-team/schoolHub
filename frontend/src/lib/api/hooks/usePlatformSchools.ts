...
export interface PlatformPlanBreakdownItem {
  id: string;
  name: string;
  type: string;
  count: number;
...
export interface PlatformPaginatedResponse<T> {
  success: boolean;
  data: T[];
  planBreakdown: PlatformPlanBreakdownItem[];
  statusBreakdown: PlatformStatusBreakdown[];
  pagination: {
    total: number;
    page: number;
    limit: number;
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await platformClient.get<
        PlatformPaginatedResponse<PlatformSchoolSummary>
      >(
        `/platform/support/schools?query=${query}&page=${page}&limit=${limit}&plan=${plan}&status=${status}`,
        {
...
export const usePlatformSchoolDetails = (id: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await platformClient.get<{
        data: PlatformSchoolDetails;
      }>(`/platform/support/schools/${id}`, {
        headers: { Authorization: `Bearer ${platform_token}` },
      });
      return data.data;
    },
...
export const useUpdateSchoolStatus = () => {
  ...
  return useMutation({
    mutationFn: async ({ id, status }: { id: string; status: string }) => {
      const { data } = await platformClient.patch<{ message: string }>(
        `/platform/support/schools/${id}/status`,
        { status },
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
...
export const useUpdateSchoolLimits = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const { data } = await platformClient.patch<{ message: string }>(
        `/platform/support/schools/${id}/limits`,
        limits,
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
    ...
    onError: (err: AxiosError<{ message?: string }>) => {
      toast.error(
        err.response?.data?.message || "Failed to update school limits",
      );
    },
  });
};
...
export const useUpdateSchoolPlan = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const { data } = await platformClient.patch<{ message: string }>(
        `/platform/support/schools/${id}/plan`,
        planData,
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
    ...
    onError: (err: AxiosError<{ message?: string }>) => {
      toast.error(
        err.response?.data?.message || "Failed to update school plan",
      );
    },
  });
};
 ...
 */
export const usePlatformStudents = (
  query: string = "",
  status: string = "ALL",
  page: number = 1,
  limit: number = 20,
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await platformClient.get<
        PlatformPaginatedResponse<PlatformStudentSummary>
      >(
        `/platform/support/students?query=${query}&status=${status}&page=${page}&limit=${limit}&plan=${plan}`,
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
      );
...
export const usePlatformStudentDetails = (id: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await platformClient.get<{
        data: PlatformStudentDetails;
      }>(`/platform/support/students/${id}`, {
        headers: { Authorization: `Bearer ${platform_token}` },
      });
      return data.data;
    },
...
export const useUpdateStudentPlan = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const { data } = await platformClient.patch<{ message: string }>(
        `/platform/support/students/${id}/plan`,
        planData,
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
    ...
    onError: (err: AxiosError<{ message?: string }>) => {
      toast.error(
        err.response?.data?.message || "Failed to update student plan",
      );
    },
  });
};
 ...
 */
export const usePlatformTeachers = (
  query: string = "",
  page: number = 1,
  limit: number = 20,
  plan: string = "ALL",
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await platformClient.get<
        PlatformPaginatedResponse<PlatformTeacherSummary>
      >(
        `/platform/support/teachers?query=${query}&page=${page}&limit=${limit}&plan=${plan}&status=${status}`,
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
      );
 ...
 */
export const usePlatformParents = (
  query: string = "",
  page: number = 1,
  limit: number = 20,
  plan: string = "ALL",
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await platformClient.get<
        PlatformPaginatedResponse<PlatformParentSummary>
      >(
        `/platform/support/parents?query=${query}&page=${page}&limit=${limit}&plan=${plan}&status=${status}`,
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
      );
...
export const usePlatformTeacherDetails = (id: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await platformClient.get<{
        data: PlatformTeacherDetails;
      }>(`/platform/support/teachers/${id}`, {
        headers: { Authorization: `Bearer ${platform_token}` },
      });
      return data.data;
    },
...
export const useUpdateTeacherPlan = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const { data } = await platformClient.patch<{ message: string }>(
        `/platform/support/teachers/${id}/plan`,
        planData,
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
    ...
    onError: (err: AxiosError<{ message?: string }>) => {
      toast.error(
        err.response?.data?.message || "Failed to update teacher plan",
      );
    },
  });
};
export const usePlatformParentDetails = (id: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await platformClient.get<{
        data: PlatformParentDetails;
      }>(`/platform/support/parents/${id}`, {
        headers: { Authorization: `Bearer ${platform_token}` },
      });
      return data.data;
    },
...
export const useUpdateParentPlan = () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const { data } = await platformClient.patch<{ message: string }>(
        `/platform/support/parents/${id}/plan`,
        planData,
        {
          headers: { Authorization: `Bearer ${platform_token}` },
        },
    ...
    onError: (err: AxiosError<{ message?: string }>) => {
      toast.error(
        err.response?.data?.message || "Failed to update parent plan",
      );
    },
  });
};
